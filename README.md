...
# 项目文档都放这里太臃肿了，我把他们放在了单独的”项目文档“文件夹
# **使用教程请看“项目文档/使用教程.md”**
# **项目结构请看“项目文档/项目规划.md”**
# **演示视频请看“项目文档/演示视频.mp4”**


# 进度记录
## V1.0
实现了基本的功能，包括添加论文、分类论文、搜索论文、以文搜图等。
进行了基本的测试验证
## V1.1
添加了批量整理功能，用户可以指定主题（如 CV, NLP, RL），系统会自动根据论文内容将其分类并移动到对应的文件夹中。
## V1.2
完善了批量整理功能，添加了对未指定主题的论文的自动分类功能。
## V1.3
完善了自动分类逻辑
